...
def main() -> None:
    ...
    threshold = 0.7032619898135847 # Similarity
    attack_model = attacks.LinfDeepFoolAttack
    ...
    f.write(f"attack_model = {attack_model}, loss_type = {loss_type}, epsilons = {epsilons}, steps = {steps}, batchsize = {batchsize}\n")
    ...
    # Run attack
    attack = attack_model(threshold=threshold, device=device, steps=steps)
