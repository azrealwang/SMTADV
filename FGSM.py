...
def main() -> None:
    ...
    f.write(f"attack_model = {attack_model}, loss_type = {loss_type}, epsilons = {epsilons}, batchsize = {batchsize}\n")
    ...
    # Run attack
    attack = attack_model(threshold=threshold, loss_type=loss_type, device=device)
