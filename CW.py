...
def main() -> None:
    ...
    attack_model = attacks.L2CarliniWagnerAttack
    ...
    f.write(f"attack_model = {attack_model}, loss_type = {loss_type}, epsilons = {epsilons}, binary_search_steps = {binary_search_steps}, steps = {steps}, step_size = {step_size}, batchsize = {batchsize}\n")
    ...
    # Run attack
    attack = attack_model(threshold=threshold, device=device, binary_search_steps=binary_search_steps, steps=steps, stepsize=step_size)
